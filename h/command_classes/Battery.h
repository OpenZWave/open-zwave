...
namespace OpenZWave
{
	...
	{
	public:
		static CommandClass* Create( uint8 const _driverId, uint8 const _nodeId ){ return new Battery( _driverId, _nodeId ); }
		virtual ~Battery(){}
	...
	private:
		Battery( uint8 const _driverId, uint8 const _nodeId ): CommandClass( _driverId, _nodeId ){}
	};
