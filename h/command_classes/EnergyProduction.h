...
namespace OpenZWave
{
	...
	public:
		enum ProductionEnum
		{
 		...
 		static CommandClass* Create( uint8 const _nodeId ){ return new EnergyProduction( _nodeId ); }
		...
		void Get( ProductionEnum _production );
	...
	private:
		EnergyProduction( uint8 const _nodeId ): CommandClass( _nodeId ){}
	};
