...
namespace OpenZWave
{
	...
	{
	public:
		static CommandClass* Create( uint8 const _driverId, uint8 const _nodeId ){ return new SensorMultilevel( _driverId, _nodeId ); }
	...
	private:
		SensorMultilevel( uint8 const _driverId, uint8 const _nodeId ): CommandClass( _driverId, _nodeId ){}
	};
