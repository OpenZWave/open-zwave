...
namespace OpenZWave
{
	...
	public:
		...
		static CommandClass* Create( uint8 const _nodeId ){ return new Protection( _nodeId ); }
		virtual ~Protection(){}
		...
		void Set( ProtectionEnum _state );
	...
	private:
		Protection( uint8 const _nodeId ): CommandClass( _nodeId ){}
	};
