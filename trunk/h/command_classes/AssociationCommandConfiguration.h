...
namespace OpenZWave
{
	...
	{
	public:
		static CommandClass* Create( uint8 const _nodeId ){ return new AssociationCommandConfiguration( _nodeId ); }
	...
	private:
		AssociationCommandConfiguration( uint8 const _nodeId ): CommandClass( _nodeId ){}
	};
