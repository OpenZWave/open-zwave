...
// Constructor
//-----------------------------------------------------------------------------
			MultiChannelAssociation::MultiChannelAssociation(uint32 const _homeId, uint8 const _nodeId) :
...
//-----------------------------------------------------------------------------
			void MultiChannelAssociation::ReadXML(TiXmlElement const* _ccElement)
			{
...
//-----------------------------------------------------------------------------
			void MultiChannelAssociation::WriteXML(TiXmlElement* _ccElement)
			{
...
//-----------------------------------------------------------------------------
			void MultiChannelAssociation::RequestAllGroups(uint32 const _requestFlags)
			{
				m_queryAll = true;
...
//-----------------------------------------------------------------------------
			void MultiChannelAssociation::QueryGroup(uint8 _groupIdx, uint32 const _requestFlags)
			{
