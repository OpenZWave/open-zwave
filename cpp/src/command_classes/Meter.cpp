...
namespace OpenZWave
{
	namespace Internal
	{
		namespace CC
		{
			...
			{ "Unknown", "Electric", "Gas", "Water" };

			static char const* c_electricityUnits[] =
			{ "kWh", "kVAh", "W", "pulses", "V", "A", "Power Factor", "" };

			static char const* c_gasUnits[] =
			{ "cubic meters", "cubic feet", "", "pulses", "", "", "", "" };

			static char const* c_waterUnits[] =
			{ "cubic meters", "cubic feet", "US gallons", "pulses", "", "", "", "" };

			static char const* c_electricityLabels[] =
			{ "Energy", "Energy", "Power", "Count", "Voltage", "Current", "Power Factor", "Unknown" };
