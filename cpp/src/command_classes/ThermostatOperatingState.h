		...
		namespace CC
		{
			...
			class ThermostatOperatingState: public CommandClass
			{
				public:
					...
					{
						return new ThermostatOperatingState(_homeId, _nodeId);
					}
					...
					{
						return ZW_CommandClasses::Thermostat_Operating_State;
					}
				...
				private:
					ThermostatOperatingState(uint32 const _homeId, uint8 const _nodeId) :
