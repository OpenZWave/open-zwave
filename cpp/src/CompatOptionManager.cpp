...
//		std::cout << "Name " << it->first << " Type: " << m_CompatVals[it->second].type << std::endl;
		...
		bool CompatOptionManager::GetFlagBool(CompatOptionFlags const flag) const
		{
		...
		uint8_t CompatOptionManager::GetFlagByte(CompatOptionFlags flag) const
		{
			if (m_CompatVals.count(flag) == 0)
			{
		...
		uint16_t CompatOptionManager::GetFlagShort(CompatOptionFlags flag) const
		{
			if (m_CompatVals.count(flag) == 0)
			{
		...
		uint32_t CompatOptionManager::GetFlagInt(CompatOptionFlags flag) const
		{
			if (m_CompatVals.count(flag) == 0)
			{
		...
		bool CompatOptionManager::SetFlagBool(CompatOptionFlags flag, bool value)
		{
			if (m_CompatVals.count(flag) == 0)
			{
		...
		bool CompatOptionManager::SetFlagByte(CompatOptionFlags flag, uint8_t value)
		{
			if (m_CompatVals.count(flag) == 0)
			{
		...
		bool CompatOptionManager::SetFlagShort(CompatOptionFlags flag, uint16_t value)
		{
			if (m_CompatVals.count(flag) == 0)
			{
		...
		bool CompatOptionManager::SetFlagInt(CompatOptionFlags flag, uint32_t value)
		{
			if (m_CompatVals.count(flag) == 0)
			{
