...
//-----------------------------------------------------------------------------
		void Msg::SetInstance(Internal::CC::CommandClass* _cc, uint8 const _instance)
		{
...
//-----------------------------------------------------------------------------
		void Msg::AppendArray(const uint8* const _data, const uint8 _length)
		{
...
//-----------------------------------------------------------------------------
		OpenZWave::Driver* Msg::GetDriver() const
		{
