...
#define SERIAL_API_SETUP_CMD_SUPPORTED					0x01
...
#define SERIAL_API_SETUP_CMD_RF_REGION_GET				0x20
#define SERIAL_API_SETUP_CMD_RF_REGION_SET				0x40
